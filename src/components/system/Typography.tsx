...
const StyledHOne = styled.h1<TextProps>`
  font-variation-settings: ${props => explodeFontSettings({...heading, ...props.fontVariation})};
`
...
const StyledP = styled.p<TextProps>`
  font-variation-settings: ${props => explodeFontSettings({...body, ...props.fontVariation})};
`
const StyledSpan = styled.span<TextProps>`
  font-variation-settings: ${props => explodeFontSettings({...body, ...props.fontVariation})};
`
const StyledEm = styled.em<TextProps>`
  font-variation-settings: ${props => explodeFontSettings({...fullSlant, ...props.fontVariation})};
`
